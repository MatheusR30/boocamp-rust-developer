// Exemplo de Destructuring (Desestruturacao)
...
//     let quantidade = linguagem.chars().count();

//     println!("Chars: {:?}", linguagem.chars());
...
// }
// fn main() {
//     let msg = Mensagem::Enviar {
//         id: 1,
//         texto: String::from("Ola, Rust!"),
//     };
...
//     // Destruturação de uma struct
//     let Ponto { x, y } = ponto;

//     println!("x: {}, y: {}", x, y);
// }

// -----------------------Exemplo que nao da para fazer em RUST
// struct Pessoa {
//     nome: String,
//     sobrenome: String,
//     idade: u8,
...
#[derive(Debug)] //Deriva o traço Debug para permitir a impressao de debug
struct Pessoa {
    nome: String,
    sobrenome: String,
    idade: u8,
...
fn main() {
    ...
    let pessoa2 = Pessoa {
        ...
        idade: *idade, // {desreferenciação} não cria uma cópia do valor;/ em vez disso, ela apenas fornece acesso ao valor original que aponte a referencia aponta.
    };
