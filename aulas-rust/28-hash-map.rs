...
// fn main() {
//     // Criação o Hash Map com valores na construcao(com array de tupla)
//     let dados: HashMap<&str, i32> = [("Largura", 10), ("Altura", 50)].iter().cloned().collect();
...
//     let dados: HashMap<&str, i32> = HashMap::from([("Largura", 10), ("Altura", 50)]);
...
//     // Usando um array de tuplas eo método collect() para construir o HashMap
...
// fn main() {
//     // Criação de um HashMap vazio onde a chave é uma String e o valor é a struct
...
//     // Adicionando uma nova chave e valor ao HasgMap apos a inicializacao
//     dimensoes.insert(
//         String::from("Sala"),
//         Dimensao {
//             largura: 10,
...
//     // Imprimindo os valore armazenados no HashMap
